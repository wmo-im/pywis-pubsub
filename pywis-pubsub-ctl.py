...
# ADDED FROM DWD
os.environ['NO_PROXY'] = '0.0.0.0,localhost'
# END ADDED
...
DOCKER_COMPOSE_ARGS = """
    ...
    --env-file my.env
    -p pywis-pubsub_project
    """

parser = argparse.ArgumentParser(
    description='manage the pywis-pubsub docker containers to subscribe and download from external wis2 nodes',
...
parser.add_argument('command',
    ...
    - login [container]: login to the container (default: mqp-subscriber)
    ...
    - status [containers|-a]: view status of pywis-pubsub container
...
def make(args) -> None:
    ...
    container = "mqp-subscriber" if not args.args else ' '.join(args.args)
